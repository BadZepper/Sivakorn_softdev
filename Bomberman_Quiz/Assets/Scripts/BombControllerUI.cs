...
public class BombControllerUI : NetworkBehaviour
{
    ...
    public IEnumerator DecreaseBomb()
    {
        bombAmount--;
        bombsRemaining --;
      ...
      public IEnumerator DecreaseBombrange()
    {
        explosionRadius--;
    ...
    public void callDecreaseBomb(){

        StartCoroutine(DecreaseBomb());
    }
    public void callDecreaseBombrange(){

        StartCoroutine(DecreaseBombrange());
    }
